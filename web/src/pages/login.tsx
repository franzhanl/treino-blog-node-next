          ...
          <div className="w-full h-100">
            ...
            <form className="mt-6" action="#" method="POST">
              <div>
                ...
                <input type="email" name="email" placeholder="exemplo@gmail.com" onChange={(e) => setEmail(e.target.value)} className="text-gray-700 w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete="" required />
              </div>
